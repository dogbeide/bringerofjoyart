...
export const metadata: Metadata = {
  title: "Privacy Policy - Bringer Of Joy",
...
export default function Page() {
  ...
  return (
    <div className="py-6 px-6">
      <h1 className="text-4xl mb-3 mt-2 tracking-wide">Privacy Policy</h1>
      <hr className="h-1 border-none mx-11" />

      <div className="section text-slate-200">
        <div className="text-left">
          <p className="font-bold mb-6">Last updated: Dec 22, 2024</p>
          <p className="mb-4">Bringer Of Joy <a className="underline" href="https://www.bringerofjoy.art">https://www.bringerofjoy.art/</a> (the “Service”).</p>
          ...
          <p className="mb-4">We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, 
            accessible at <a className="underline " href="https://www.bringerofjoy.art">https://www.bringerofjoy.art/</a>.</p>

          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Information Collection And Use</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Log Data</h2>
          <p className="mb-4">We collect information that your browser sends whenever you visit our Service (“Log Data”). This Log Data may include information such as your computer&apos;s Internet Protocol (“IP”) address, browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages and other statistics.</p>

          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Cookies</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Service Providers</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Security</h2>
          <p className="mb-4">The security of your Personal Information is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Information, we cannot guarantee its absolute security.</p>

          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Links To Other Sites</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Children&apos;s Privacy</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Compliance With Laws</h2>
          <p className="mb-4">We will disclose your Personal Information where required to do so by law or subpoena.</p>

          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Changes To This Privacy Policy</h2>
          ...
          <h2 className={`text-4xl mb-3 mt-2 tracking-wide`}>Contact Us</h2>
          <p className="mb-4">If you have any questions about this Privacy Policy, please <a className="underline text-pandoras-teal hover:text-pandoras-lime" href="/#connect">contact us</a>.</p>
        </div>
      </div>
    </div>
  )
